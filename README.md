...
> **1,599 memories** · **33 MCP tools** · **Graph + Vector hybrid retrieval** · **sub-200ms search** · **1,147 tests**
...
├── tests/
│   ├── unit/                   # 1,147 tests (3-evil/1-sad/1-happy per function)
...
- **1,147 tests** across 73 unit test files, 0 failures, 0 skipped
