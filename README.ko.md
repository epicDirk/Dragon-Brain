...
[![테스트](https://img.shields.io/badge/tests-1%2C147%20passing-brightgreen)]()
...
> **1,599개의 기억** · **33개의 MCP 도구** · **지식 그래프 + 벡터 검색 하이브리드** · **200ms 미만 검색** · **1,147개 테스트**
...
프로덕션 수준 테스트: **1,147개 유닛 테스트** · 뮤테이션 테스트 (3-evil/1-sad/1-happy) · 속성 기반 테스트 (38개 Hypothesis 속성) · 퍼즈 테스트 (30K+ 입력, 크래시 0) · 정적 분석 (mypy strict, ruff) · 보안 감사 · **Gauntlet 점수: A- (95/100)**.
