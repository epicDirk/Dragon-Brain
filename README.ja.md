...
[![テスト](https://img.shields.io/badge/tests-1%2C147%20passing-brightgreen)]()
...
> **1,599件のメモリ** · **33個のMCPツール** · **ナレッジグラフ + ベクトル検索ハイブリッド** · **200ms未満の検索** · **1,147個のテスト**
...
プロダクショングレードのテスト：**1,147個のユニットテスト** · 変異テスト（3悪/1悲/1喜）· プロパティベーステスト（38個のHypothesisプロパティ）· ファズテスト（30K+入力、クラッシュ0）· 静的解析（mypy strictモード、ruff）· セキュリティ監査 · **Gauntletスコア：A-（95/100）**。
